...
#elif defined(__SDCC_PIC16F1827) //set by cmdline or MPLAB IDE
 #define extern //kludge: force compiler to include defs
 #include <pic14/pic16f1827.h>
 #undef extern
//#ifdef __PIC16F1827_H__
 #define PIC16X //extended instr set
 #define HIGHBAUD_OK  TRUE //PIC16F688 rev A.3 or older should be FALSE; newer can be TRUE
 #define LINEAR_RAM  0x2000
// #define PIC16F1827
 #define _SERIN_PIN  _RB1 //0xC5C5 //;serial input pin
 #define _SEROUT_PIN  _RB2 //0xC4C4 //;serial output pin
// #define CLKIN_PIN  _RA5 //0xA5 //;ext clock pin; might be available for LED control
// #define _ZC_PIN  PORTPIN(_PORTA, bit2inx(_RA3)) //0xA3  //;this pin can only be used for input; used for ZC/config
 #define PORTA_MASK  0x7f
 #define PORTB_MASK  0x7f
...
//bits:
#if !defined(NOT_WPUEN) && defined(NOT_RAPU)
 #define NOT_WPUEN  NOT_RAPU
// #define SPBRGL_ADDR  SPBRG_ADDR
// #warning "SPBRGL equate"
#endif

#if !defined(TMR1IF) && defined(T1IF)
 #define TMR1IF  T1IF
#endif

//regs:
#if !defined(SPBRGL_ADDR) && defined(SPBRG_ADDR) //def SPBRG_ADDR
 #define SPBRGL  SPBRG
 #define SPBRGL_ADDR  SPBRG_ADDR
// #warning "SPBRGL equate"
#endif
